...
### [1] [Learning the Language of the Microbiome with Transformers](https://www.biorxiv.org/content/10.64898/2026.05.02.722381)
*Treloar, N. J., Ur-Rehman, S., Yang, J.*

Main category: machine learning

TL;DR: Self-supervised pretraining has become central to biological machine learning, yet microbiome data remains comparatively underexplored in terms of both modeling approaches and evaluation frameworks. To address this gap, we present Atlas, a pretraining dataset of 539,308 microbiome datapoints from the MGnify database. Using Atlas, we train the Waypoint family of...
...
### [2] [Generative machine learning unlocks the first proteome-wide image of human cells](https://www.biorxiv.org/content/10.64898/2026.03.31.715748)
*Sun, H., Kahnert, K., Hansen, J. N., Leineweber, W. D., Li, M., Feng, W., Ballllosera Navarro, F., Axelsson, U., Ouyang, W., Lundberg, E.*

Main category: machine learning

TL;DR: The spatial organization of proteins within cells governs virtually all cellular functions, yet current imaging can simultaneously visualize only tens of proteins, orders of magnitude below the thousands populating a single human cell. Here we present ProtiCelli, a deep generative model that simulates microscopy images for 12,800 human proteins from...
...
### [3] [Dissociation kinetics and avidity gate SARS-CoV-2 neutralization by HR2 stem helix antibodies](https://www.biorxiv.org/content/10.64898/2026.08.17.745160)
...
### [4] [A Computational Foundation Toward Targeting the ELMO1/DOCK2 Complex](https://www.biorxiv.org/content/10.64898/2026.07.27.740996)
...
### [5] [Deep Learning-based Modeling Enhances Efficacy of Natural Ligand CAR Binders Targeting CD70](https://www.biorxiv.org/content/10.64898/2026.09.06.749651)
*Kang, A. S., Dalal, R., Li, M., Ojha, A. A., Walunj, S., Cornell, C. E., Rahnama, R., Barpanda, A., Prudhvi, S., Patel, T., Aspinall-O'Dea, M., Walker, B., Adams, C., Steri, V., Phojanakong, P., Camara Serrano, J. A., Li, H., Rivera, J., Fletcher, D. A., Huang, B. J., Hanson, S. M., Cossio, P., Kortemme, T., Eyquem, J., Wiita, A. P.*

Main category: molecular dynamics

TL;DR: CD70 is well-recognized as a promising "pan-cancer: chimeric antigen receptor (CAR) T-cell target. Prior work has shown that a "natural ligand" (NL)-based CAR targeting CD70, employing its physiological interaction partner CD27, may have therapeutic advantages over antibody-based CARs. Yet while antibody-based CARs are routinely optimized by affinity maturation of their...
