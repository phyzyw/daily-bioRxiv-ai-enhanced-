...
### [1] [Artificial intelligence aided design of peptides with custom secondary structure motifs and reduced amino acid alphabets](https://www.biorxiv.org/content/10.64898/2026.04.29.721096)
*Brown, S. M., Cohen, A. B., Dean, S. N.*

Main category: machine learning

TL;DR: AI protein design model generates novel proteins with desired secondary structure motifs.


<details>
  <summary>Details</summary>
Motivation: Bridging biological theory with AI to improve protein design.

Method: Training on RSCB PDB, reduced amino acid alphabets, and DSSP secondary structure.

Result: Novel proteins with desired secondary structure motifs, often capturing full 3D tertiary structure.

Conclusion: Advances research in AI/ML, biotechnology, astrobiology, and early-Earth evolutionary biology.
