...
### [1] [Image-based Disease-wide Association Study via Self-supervised Learning links Abdominal MRI Features to 158 Diseases](https://www.biorxiv.org/content/10.64898/2026.07.23.740409)
*Mousavi, S., Arora, J., Agarwal, R., Fischer, A., Mueller, S., Ding, Z., de Jong, J., Yuan, K.*

Main category: machine learning

TL;DR: Medical images contain rich phenotypic information that is often not fully captured by manual clinical assessment. Here, we present a systematic framework for extracting such information and conducting image-based disease-wide association studies (iDWAS) using self-supervised learning (SSL). We applied this framework to abdominal MRI data from the UK Biobank and...
...
### [4] [SketchDNA: A GUI-Enabled Toolkit for Multiscale Modeling of Topological DNA Structures](https://www.biorxiv.org/content/10.64898/2026.07.27.741011)
...
### [5] [How a highly acidic SH3 domain binds to its intrinsically disordered partner through the formation of an encounter complex intermediate](https://www.biorxiv.org/content/10.64898/2026.07.28.741257)
...
TL;DR: Electrostatic interactions often play a role in determining the thermodynamic and kinetic properties of protein-protein interactions. However, the role of long-range electrostatic interactions in intrinsically disordered protein (IDP) binding is less clear, as they often bind in multiple steps including initial formation of a disordered encounter complex, followed by rearrangement...
...
### [6] [Asymmetry and Allostery: Insights into the Mechanism of DirectionalPeptide Translocation in AAA+ Unfoldases](https://www.biorxiv.org/content/10.64898/2026.07.27.741010)
*Southam, T. G., Oh, M., Swanson, J. M.*

Main category: molecular dynamics

TL;DR: Molecular motors convert stochastic ATP chemistry into directional motion. Modern nonequilibrium theories explain this behavior through kinetic asymmetry, yet the molecular mechanisms that generate kinetic asymmetry in AAA+ unfoldases remain unresolved. Cryo-electron microscopy has consistently revealed unfoldases take on an asymmetric helical staircase structure, inspiring the proposed processive hand-over-hand translocation...
...
### [8] [Anticodon nucleotide modifications affect translational tuning by the ribosomal CAR surface](https://www.biorxiv.org/content/10.64898/2026.07.29.740946)
*Raval, M., Zhou, Y., Wichman, M., Lynch, M., Krizanc, D., Thayer, K. M., Weir, M. P.*

Main category: molecular dynamics

TL;DR: Nucleotide modifications of the tRNA anticodon can affect protein translation fidelity and speed. Chemical modifications of the anticodon nucleotide 34 are regulated under cellular stress and associated with several translational defects and pathologies. Here, we investigate how these modifications influence A-site codon recognition interactions and their coupling to the CAR...
