...
### [1] [Machine learning cross-platform proteomic imputation enables protein quality scoring and replication of epidemiological associations](https://www.biorxiv.org/content/10.64898/2026.05.05.723059)
...
TL;DR: 基于机器学习的跨平台蛋白质值补偿框架解决了蛋白质生物标志物发现的平台驱动非复制问题


<details>
  <summary>Details</summary>
Motivation: 平台驱动非复制问题阻碍了生物标志物发现和验证

Method: 使用机器学习模型对SomaScan和Olink平台的蛋白质数据进行补偿

Result: 框架实现了蛋白质值补偿、平台独特蛋白质测量的恢复和重叠蛋白质的校准

Conclusion: 该框架可以提高生物标志物发现的可靠性和平台的优化
...
### [5] [A ML-framework for the discovery of next-generation IBD targets using a harmonized single-cell atlas of patient tissue](https://www.biorxiv.org/content/10.64898/2026.02.06.699999)
...
TL;DR: 使用单细胞RNA数据发现IBD新疗法


<details>
  <summary>Details</summary>
Motivation: 传统IBD目标发现方法缺乏细胞分辨率

Method: AMICA DBTM、Immune Patient Representation、机器学习框架

Result: 85个疾病相关转录程序、400个细胞类型特异目标基因

Conclusion: 验证了两种细胞类型特异候选基因，支持了新疗法的可能性
...
### [8] [Know Your Alphabet: Conformational Noise, Latent-Space Encodings, and the Future of Structural Phylogenetics](https://www.biorxiv.org/content/10.64898/2026.05.06.722973)
*Schmid, M., Liu, Y., Malik, A. J., Ascher, D.*

Main category: molecular dynamics

TL;DR: 结构alphabets对蛋白质phylogenetics的影响


<details>
  <summary>Details</summary>
Motivation: 量化结构alphabets中的噪音

Method: NNI指标和RF方差

Result: 噪音对phylogenetic inference的影响

Conclusion: alphabets选择是结构phylogenetics的方法变量
...
### [9] [Expanding the Enzymatic Landscape for Polyurethane Degradation of Novel Bacterial Urethanases](https://www.biorxiv.org/content/10.64898/2026.02.11.705263)
*Rotilio, L., Oestergaard, R. R., Thiesen, E. M., Paiva, P., Dwyer, K. M., Johansen, M. B., Sommerfeldt, A., Sandahl, A., Keller, M. B., Siebenhaar, S., Graham, R., Otzen, D. E., Fernandes, P. A., Ramos, M. J., Westh, P., Morth, J. P.*

Main category: molecular dynamics

TL;DR: 新发现五种细菌尿丙烯酶，用于PUR降解


<details>
  <summary>Details</summary>
Motivation: PUR难以回收，需要新型降解方法

Method: 鉴定和表征五种尿丙烯酶

Result: 两种候选酶u15和u17显示高活性和稳定性

Conclusion: 酶结构分析和模拟表明了酶的活性机理
...
### [12] [An all-atom view into the disordered interaction interface of the TRIM5α PRYSPRY domain and the HIV capsid](https://www.biorxiv.org/content/10.1101/2024.12.06.627233)
*Haas-Neill, L., Meneksedag-Erol, D., Andeejani, I., del Banco, S., Tenthorey, J., Rauscher, S.*

Main category: molecular dynamics

TL;DR: TRIM5 protein variants differ in HIV restriction ability, and simulations reveal structural basis for this difference.


<details>
  <summary>Details</summary>
Motivation: Understanding TRIM5-HIV capsid interaction interface and functional differences between variants.

Method: All-atom molecular dynamics simulations of TRIM5 variants and HIV capsid protein.

Result: Conformational ensembles of TRIM5 variants and fuzzy interaction interface with HIV capsid protein.

Conclusion: R332P mutation enhances HIV restriction by reducing electrostatic repulsion with capsid protein.
...
### [13] [Nucleotide-dependent Structural Selection Governs c-Src Phosphorylation of Oncogenic KRas4B-G12D](https://www.biorxiv.org/content/10.64898/2026.03.17.712316)
*Lu, H., Xu, H., Marti, J., Ma, B., FARAUDO, J.*

Main category: molecular dynamics

TL;DR: c-Src recognizes GTP-bound KRas4B-G12D through open and dynamic switch regions, facilitating phosphorylation.


<details>
  <summary>Details</summary>
Motivation: Understanding c-Src recognition of oncogenic KRas mutants for targeted therapy.

Method: Molecular Dynamics simulations, Markov State Models, and docking calculations.

Result: c-Src selectively recognizes GTP-bound KRas conformations, sparing GDP-bound form.

Conclusion: KRas conformations recognized by c-Src are privileged targets for inhibitor design.
