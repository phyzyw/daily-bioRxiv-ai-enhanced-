...
### [1] [Limited role of climate change in out-of-season Joshua tree flowering](https://www.biorxiv.org/content/10.64898/2026.05.22.727294)
*Yoder, J. B., Carlson, C. J., Callahan, C. W.*

Main category: machine learning

TL;DR: One of the most visible and well-documented effects of global climate change is the advancement of spring phenology in temperate-zone plant populations. When community scientists reported Joshua trees (Yucca brevifolia and Y. jaegeriana) flowering in October 2025--fully four months in advance of their normal flowering onset--many speculated the bloom was...
...
Abstract: One of the most visible and well-documented effects of global climate change is the advancement of spring phenology in temperate-zone plant populations. When community scientists reported Joshua trees (Yucca brevifolia and Y. jaegeriana) flowering in October 2025--fully four months in advance of their normal flowering onset--many speculated the bloom was caused by climate change. We tested this hypothesis using the emerging practice of climate change attribution, which is increasingly used to identify how anthropogenic climate change has contributed to extreme weather events, but which has not, to our knowledge, been applied to anomalous ecological phenomena like the winter 2025-6 Joshua tree bloom. We used crowdsourced observations of Joshua tree flowering from the iNaturalist platform to train machine learning models that reliably identify weather triggers for seasonal and out-of-season Joshua tree flowering. We then used results from ten global climate models to simulate weather conditions in a counterfactual world without human-caused climate change, and used our trained model to predict Joshua tree flowering from those counterfactual conditions. Surprisingly, we found winter blooms in 2018-9 and 2025-6 were driven by high winter rainfall, not rising temperatures--and therefore, are probably the result of natural weather variability, not climate change. Our results provide a template for future attribution analyses of extreme ecological events, and identify important future directions for climate modeling.

</details>


### [2] [Quantum machine learning for detection of sleep deprivation from EEG signals](https://www.biorxiv.org/content/10.64898/2026.06.14.732153)
...
### [3] [A hybrid framework integrating structural machine learning and 3D liver-on-chip assay for drug-induced liver injury prediction](https://www.biorxiv.org/content/10.64898/2026.06.15.732231)
*Zhang, F., Zhou, Y., Ding, D., Zhang, F., Xiao, R., Ai, X.*

Main category: machine learning

TL;DR: Drug-induced liver injury (DILI) remains one of the most pressing challenges in drug development, contributing to 25-30% of late-stage clinical attrition and representing a leading cause of post-marketing drug withdrawals. Here, we introduce Oakuloid, a hybrid DILI prediction framework that combines a stacked ensemble of three gradient-boosted decision-tree models, including...
...
### [4] [Structural basis of half-site reactivity in the catalytic α-subunit of Class Ib ribonucleotide reductases](https://www.biorxiv.org/content/10.64898/2025.12.21.695763)
*Yadav, L. R., Chauhan, S. B., Joshi, M., Mande, S. C.*

Main category: molecular dynamics

TL;DR: Ribonucleotide reductases (RNRs) employ radical chemistry to generate deoxyribonucleotides required for DNA synthesis and repair. A notable feature of RNRs is half-site reactivity, where, despite the enzyme being a symmetric dimer, only one active site is catalytically active at a time while the other remains in a ''poised'' state for...
...
### [6] [Mechanistic Insights into Unfolding of the Mitochondrial Localization Sequence M1 of TDP-43 and Identification of a MAPKAPK2 Inhibitor as a potential binder of M1 for inhibition of TDP-43's Aberrant Mitochondrial Localization](https://www.biorxiv.org/content/10.64898/2026.06.17.732848)
*Balaji, R., Bhardwaj, S., Baa, J., Joshi, H., Patel, B. K.*

Main category: molecular dynamics

TL;DR: Mechanistic elucidation and inhibition of the pathogenic aberrant mitochondrial localization of the RNA/DNA-binding protein, TDP-43, can help in the therapeutics of the neurodegenerative disease amyotrophic lateral sclerosis (ALS). A mitochondrial localization sequence of TDP-43, M1, is largely solvent inaccessible; therefore, how it interacts with the mitochondrial import machinery to facilitate...
