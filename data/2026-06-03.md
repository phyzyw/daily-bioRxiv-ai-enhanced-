...
### [1] [Species- and Topic-aware Representation Learning for Antimicrobial Peptide Discovery](https://www.biorxiv.org/content/10.64898/2026.05.28.728246)
...
TL;DR: Antimicrobial resistance poses a major global health challenge, necessitating efficient strategies to discover potent antimicrobial peptides (AMPs). While recent generative models can produce many candidate sequences, experimentally validating all generated peptides in wet labs is impractical due to the high costs and time involved in such measurements. As a result,...
...
### [2] [The machine-learning classifier ALLCatchR2 identifies 20 T-ALL subtypes across cohorts and age groups](https://www.biorxiv.org/content/10.64898/2026.01.01.697268)
*Beder, T., Wolgast, N., Walter, W., Bendig, S., Hartmann, A. M., Barz, M. J., Zaliova, M., Reitzel, E., Baden, D., Schwartz, S. M., Gökbuget, N., Kester, L., Trka, J., Haferlach, C., Brüggemann, M., Baldus, C. D., Neumann, M., Bastian, L.*

Main category: machine learning

TL;DR: T-cell acute lymphoblastic leukemia (T-ALL) comprises molecularly diverse subtypes, but robust cross-cohort validations and operational gene-expression definitions are lacking. To establish a gene-expression-anchored framework for T-ALL subtyping, we aggregated 2,314 transcriptomes (15 cohorts, age: 0.8 to 90.8 years). An extended unsupervised approach defined 17 main clusters and 3 subclusters in...
...
### [5] [Temperature-Dependent Rotamer Population Shifts Govern Tryptophan Fluorescence in Proteins](https://www.biorxiv.org/content/10.64898/2026.05.22.726722)
*Hsu, I.-S., Chou, Y.-C., Wang, W.-H., Tsai, M.-Y.*

Main category: molecular dynamics

TL;DR: Intrinsic tryptophan fluorescence is widely used as a sensitive reporter of protein conformational dynamics, yet the molecular origin of its temperature-dependent modulation remains unclear. Here we investigate the conformational dynamics of Trp134 in bovine serum albumin (BSA) using molecular dynamics (MD) simulations, free-energy calculations based on umbrella sampling and WHAM,...
...
### [6] [Structure and dynamics of a multidomain ligand-gated ion channel revealed under acidic conditions](https://www.biorxiv.org/content/10.1101/2025.02.27.640520)
*Anden, O., Rovsnik, U., Lycksell, M., Delarue, M., Howard, R. J., Lindahl, E.*

Main category: molecular dynamics

TL;DR: Pentameric ligand-gated ion channels are critical mediators of electrochemical signal transduction across evolution, including key targets of biophysical studies and therapeutic development. However, the intrinsically allosteric, polymodal, modular nature of gating in this protein family presents persistent challenges to biophysical characterization. The bacterial channel DeCLIC constitutes a provocative model system...
...
### [9] [Genotype-Resolved Interaction Landscape of the Dengue Envelope Glycoprotein with Host Cellular Proteins: Structural Dynamics, Thermodynamic Cooperativity, and Binding Specificity](https://www.biorxiv.org/content/10.64898/2026.05.31.728572)
*Neto, D. F. d. L., Teixeira, J. P., Corat, M. A. F., Bajay, M. M., Trossini, G. H. G., Mansur, D. S., Leal, E. d. S., Janini, L. M. R., Freire, C. C. d. M.*

Main category: molecular dynamics

TL;DR: Dengue virus (DENV) is a mosquito-borne flavivirus responsible for approximately 390 million infections annually, representing one of the most significant global public health challenges among arboviruses. The dengue envelope (E) glycoprotein is the principal mediator of viral attachment, receptor recognition, and membrane fusion during host cell entry. This study characterizes...
...
Abstract: Dengue virus (DENV) is a mosquito-borne flavivirus responsible for approximately 390 million infections annually, representing one of the most significant global public health challenges among arboviruses. The dengue envelope (E) glycoprotein is the principal mediator of viral attachment, receptor recognition, and membrane fusion during host cell entry. This study characterizes the structural interaction landscape between sixteen dengue envelope genotype variants and a curated panel of host proteins involved in viral attachment, endocytic trafficking, immune signaling, and vascular regulation. Three-dimensional structural models were obtained through a hierarchical pipeline integrating experimentally determined structures, AlphaFold predictions, I-TASSER template-based modeling, and MODELLER refinement, followed by molecular dynamics relaxation. Protein--protein docking simulations were performed using HDOCK across all envelope--host protein combinations. Interaction interfaces were quantitatively characterized through a vector-based formalism encoding hydrogen bond directionality, occupancy, and angular entropy. To approximate cellular interaction environments, triple docking simulations incorporating first-neighbor host proteins were implemented under both pre-assembly and post-assembly scenarios, and binding cooperativity was evaluated through DeltaDelta G thermodynamic analysis. This framework provides a multiscale representation of viral--host interaction architecture and identifies structural determinants potentially associated with viral entry, host immune modulation, and vascular pathogenesis.

</details>


### [10] [(2R,6R)-Hydroxynorketamine elicits rapid antidepressant effects by promoting astrocytic μ-δ opioid receptor heterodimerization](https://www.biorxiv.org/content/10.64898/2026.05.31.729044)
*Liang, Y., Wang, L., Li, Y., Li, X., Sun, Y., Yang, M., Guo, X., Mu, J., Xu, C., Thapa, R., Cheng, Y., Zhang, H., He, Z., Yan, S., Yang, S., Fong, T. H., Bai, H., Xu, J., Zhang, Q., Lui, L., Li, M., Xu, D., Geng, W., Su, J., Tang, A., Wang, C., Zhou, Q., Cai, X.*

Main category: molecular dynamics

TL;DR: Ketamine produces rapid antidepressant effects but is constrained by psychotomimetic properties and abuse potential. The ketamine metabolite (2R,6R)-hydroxynorketamine (HNK) shows antidepressant-like efficacy without N-methyl-D-aspartate receptor (NMDAR) blockade, yet its upstream targets remain unclear. Here we show that HNK potentiates hippocampal excitatory transmission and reverses stress-induced behavioural deficits through opioid receptor...
