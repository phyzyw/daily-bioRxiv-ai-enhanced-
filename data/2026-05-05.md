...
### [1] [MolGene-E: Inverse Molecular Design to Modulate Single Cell Transcriptomics](https://www.biorxiv.org/content/10.1101/2025.02.19.638723)
*Ohlan, R., Murugan, R., Xie, L., Nallabolu, V., Mottaqi, M., Zhang, S., Xie, L.*

Main category: machine learning

TL;DR: MolGene-E：一个深度生成框架，用于基于单细胞转录omics数据设计新药物分子。


<details>
  <summary>Details</summary>
Motivation: 解决传统药物发现方法无法满足医疗需求的挑战。

Method: 结合跨模式模型和对比学习生成模型，生成新药物分子。

Result: 在两个评估设置中，MolGene-E consistently outperforms baseline methods。

Conclusion: MolGene-E是一个有潜力新工具，用于药物发现。
...
### [2] [Psychedelics Align Brain Activity with Context](https://www.biorxiv.org/content/10.1101/2025.03.09.642197)
*Stoliker, D., Novelli, L., Khajehnejad, M., Biabani, M., Greaves, M. D., Barta, T., Williams, M., Chopra, S., Bazin, O., Simonsson, O., Chambers, R., Barrett, F., Deco, G., Seth, A., Preller, K. H., Carhart-Harris, R., Sundram, S., Egan, G. F., Razi, A.*

Main category: machine learning

TL;DR: Psilocybin alters brain connectivity, context-sensitive, and linked to subjective experience and behavioral change.


<details>
  <summary>Details</summary>
Motivation: Understanding psychedelic effects on brain connectivity and subjective experience.

Method: Functional MRI and EEG, 62 participants, psilocybin ingestion, machine learning analysis.

Result: Context-sensitive brain activity patterns, neural trajectories, and embeddedness experience.

Conclusion: Context-alignment of brain activity linked to psychedelic state, subjective experience, and behavioral change.
