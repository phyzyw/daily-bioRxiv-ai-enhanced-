...
### [1] [Large datasets and machine learning models fail to capture extremophile enzyme melting and optimum temperatures](https://www.biorxiv.org/content/10.64898/2026.06.15.732300)
*Gault, S.*

Main category: machine learning

TL;DR: Organisms and their enzymes adapt to environmental temperatures, such that thermophilic enzymes exhibit high melting and optimum temperatures while psychrophilic enzymes exhibit low values for both. It has been proposed that the gap between an enzyme's optimum temperature and its melting temperature, the temperature gap, is characteristically large in psychrophiles,...
...
### [4] [A Shape Analysis Algorithm Quantifies Spatial Morphology and Context of 2D to 3D Cell Culture for Novel Quantitation of Phenotypes](https://www.biorxiv.org/content/10.64898/2026.02.02.703425)
*Nguyen, D. H., Bruck, M., Rosenbluth, J.*

Main category: machine learning

TL;DR: Numerous studies have shown that the morphological phenotype of a cell or organoid correlates with its susceptibility to anti-cancer agents. However, traditional methods of measuring phenotype rely on spatial metrics such as area, volume, perimeter, and signal intensity, which work but are limited. These approaches cannot measure many crucial features...
...
### [7] [PhenoBIC: operator-free single-cell spatial phenotyping in multiplex imaging data using deep learning of cell staining patterns](https://www.biorxiv.org/content/10.64898/2026.06.11.731702)
*Sankaranarayanan, A., Zhao, C., Hernandez, M. G., Clemens, E. A., Smythe, K. S., Kazerouni, A. S., Carr, L. L., Li, C. I., Partridge, S. C., Vinayak, S., Mittal, S.*

Main category: machine learning

TL;DR: Multiplex imaging is a valuable tool for spatially examining tissue microenvironments at the single-cell level to uncover biological and clinical insights. However, most multiplex image analysis workflows currently require manual intervention for cell phenotyping, which slows progress, demands human effort, and yields operator-dependent outputs. Here, we developed PhenoBIC, a pre-trained...
...
### [8] [Machine learning surrogate forward models for biomechanical laryngeal control](https://www.biorxiv.org/content/10.64898/2026.06.12.731734)
*Parra Pena, J. A., Sorolla, C., Quinteros Veas, N. F., Ibarra, E. J., Alzamendi, G. A., Peterson, S. D., Weerathunge, H. R., Guenther, F. H., Zanartu, M.*

Main category: machine learning

TL;DR: Accurate modeling of laryngeal motor control is key to understanding typical and disordered voice production. However, traditional biomechanical plant models based on ordinary differential equations (ODEs) often involve high computational costs and numerical instabilities, limiting their use in real-time closed-loop control frameworks. This study evaluates feature-driven machine learning (ML) regressors,...
...
### [10] [Infectious Disease Forecasting via Physics-Informed Machine Learning](https://www.biorxiv.org/content/10.64898/2026.06.12.731957)
*Hart, J. C., Smith, H., McMahan, C., Rennert, L.*

Main category: machine learning

TL;DR: Infectious disease transmission evolves as a dynamic process shaped by biological mechanisms, population behavior, and intervention policies, yet public health responses are often driven by lagging indicators. Accurate short- and long-term disease forecasting is essential for the timely deployment of intervention strategies, healthcare capacity planning, and uncertainty-aware, risk-informed decision-making. To...
...
### [12] [Parameterization of the PA endonuclease bimetallic center reveals the dynamics of clinically relevant mutations](https://www.biorxiv.org/content/10.64898/2026.06.12.731895)
*Wang, L., Li, P., Sztain, T.*

Main category: molecular dynamics

TL;DR: Influenza A virus continues to impose a major global health and economic burden through seasonal epidemics and occasional pandemics, highlighting the critical need for continued antiviral development. As the latest addition to anti-influenza therapy, baloxavir marboxil (BXM) targets the highly conserved PA N-terminal endonuclease domain (PAN), blocking the cap-snatching process...
