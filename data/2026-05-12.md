...
### [1] [Facility-Scale Workflows for Data Acquisition, Standardization, Machine Learning Analysis, and Reproducible Science](https://www.biorxiv.org/content/10.64898/2026.05.06.723241)
...
TL;DR: 建立了一个可部署的、设施规模的基础设施，连接仪器级数据生成和云基于ML分析


<details>
  <summary>Details</summary>
Motivation: 解决了大规模显微镜数据的标准化、处理和可视化问题

Method: 结合本地云计算、Pycroscopy生态系统和开源元数据管理平台

Result: 将异构显微镜数据转换为标准化的ML准备表示

Conclusion: 为设施规模数据和AI基础设施提供了可复制的蓝图
...
### [2] [Reveal Principles of Codon Optimization via Machine Learning](https://www.biorxiv.org/content/10.64898/2026.04.16.718958)
*Deng, F., Li, H., Sun, D., Duan, G., Sun, Z., Xue, G.*

Main category: machine learning

TL;DR: 高水平蛋白表达优化工具OptimWiz 2.1和OptimWiz 3.0的开发
...
TL;DR: CD48在多发性骨髓瘤中发挥复杂作用，初期激活NK细胞，后期却导致NK细胞疲劳


<details>
  <summary>Details</summary>
Motivation: 研究CD48在多发性骨髓瘤中的作用和机理

Method: 多组学方法，包括bulk和single-cell RNA-seq、ATAC-seq、CRISPR-KO/a screens和机器学习

Result: CD48在MM中初期激活NK细胞，后期却导致NK细胞疲劳

Conclusion: CD48的作用是context-dependent的，需要根据临床情况进行调控

Abstract: Multiple myeloma (MM) orchestrates immune evasion by subverting natural killer (NK) cell function. CD48, one of the most abundant NK-ligands on MM cells, paradoxically enhances NK-cell activation yet is associated with high-risk cytogenetics and poor patient survival. We integrated multi-omics (bulk and single-cell RNA-seq, ATAC-seq), genome-wide CRISPR-KO/a screens, and machine learning to dissect CD48 regulation and function. In human MM and Vk*MYC mice scRNA-seq datasets, NK cells exhibit stepwise increases in inflammatory and exhaustion signatures and loss of cytotoxic potential as disease progresses. In vitro co-culture assays show CD48 overexpression on MM enhances initial NK-cell cytotoxicity and cytokine secretion, whereas chronic exposure leads to ex vivo NK dysfunction. In vivo, CD48-overexpressing Vk*MYC tumors progress more slowly and extend host survival, while NK-cell depletion accelerates disease. These findings support a context-dependent role for CD48, potentiating acute NK responses while coexisting with chronic NK exhaustion, and suggest strategies to modulate CD48 for therapeutic benefit.

</details>


### [7] [Machine Learning Analysis to Define Cell Lineage in Leiomyosarcoma](https://www.biorxiv.org/content/10.64898/2026.05.08.723931)
*van IJzendoorn, D. G. P., Przybyl, J., Hastie, T., Bovee, J. V. M. G., Matusiak, M., van de Rijn, M.*

Main category: machine learning

TL;DR: LMS分类基于DNA甲基化签名


<details>
  <summary>Details</summary>
Motivation: 区分LMS的 Smooth Muscle来源

Method: EPIC methylation profiling + Random Forest + CIBERSORTx

Result: LMS-wall vs LMS-vessel methylation signature differences

Conclusion: LMS-wall and LMS-vessel differ in PD-1 pathway activation and immune cell populations
...
### [8] [The Second Brain: Diffusion Models for Realistic Human Microbiome Generation](https://www.biorxiv.org/content/10.64898/2026.05.07.723523)
*Yee, B., Fu, J.*

Main category: machine learning

TL;DR: The human microbiome is a critical determinant of health and disease, but microbiome machine learning is constrained by limited data availability, heterogeneous cohort coverage, and privacy risks from individually identifying microbial signatures. Synthetic microbiome generation could support method development and privacy-preserving sharing, provided that generated samples preserve the ecological zero-inflation...
...
TL;DR: LN诊断和治疗中使用血清蛋白质组学


<details>
  <summary>Details</summary>
Motivation: LN诊断和治疗中缺乏非侵入性标志物

Method: 血清蛋白质组学 profiling 和机器学习

Result: 发现了LN与健康对照、病理学类别和活动-chronicity相关的蛋白质签名

Conclusion: 血清蛋白质组学可能成为LN诊断和治疗的非侵入性液体生物标志物
