...
### [1] [Overcoming systematic data biases enables accurate prediction of enzyme kcat fold-changes for computational protein design](https://www.biorxiv.org/content/10.64898/2026.01.23.701068)
*Rousset, Y., Kroll, A., Lercher, M.*

Main category: machine learning

TL;DR: 机器学习用于蛋白质工程预测突变对酶活性的影响，但模型性能可能受数据偏见影响


<details>
  <summary>Details</summary>
Motivation: 评估模型是否真正捕捉突变特异效应或只是利用数据统计规律

Method: 提出偏见-aware框架，使用pairwise fold-change任务评估模型性能

Result: 简单baseline匹配或超过现有模型，新的框架解释约一-third的变异

Conclusion: 评估和建模突变效应的通用策略，影响蛋白质工程和相关领域
...
### [2] [Systems Pharmacology Reveals Type I Interferon and Myeloid-Like B Cell Reprogramming as Druggable Axes in Antiphospholipid Syndrome](https://www.biorxiv.org/content/10.64898/2026.04.28.721277)
*Sun, B., Lu, Y., Liu, W., Wang, C.*

Main category: machine learning

TL;DR: APS lacks targeted therapies, this study uses systems pharmacology to identify druggable targets.


<details>
  <summary>Details</summary>
Motivation: Characterize molecular heterogeneity and identify targeted therapies for APS.

Method: WGCNA, single-cell RNA sequencing, CMap screening, molecular docking, and machine learning.

Result: Identified druggable targets in IFN-I and degranulation pathways, validated by CMap and external validation.

Conclusion: Nominates targets for pathway-guided precision medicine in APS, providing a foundation for future research.
...
### [6] [Enhancing the Understanding of Environmental Microbiomes through Topic Modeling: A Quantitative and Qualitative Analysis](https://www.biorxiv.org/content/10.64898/2026.04.28.721390)
*Kujat, A. S., Hassenrück, C., Lüdtke, S., Labrenz, M., Sperlea, T.*

Main category: machine learning

TL;DR: 使用主题模型分析微生物群落数据，探索其在环境监测中的应用


<details>
  <summary>Details</summary>
Motivation: 理解生态系统动态，微生物群落数据高维度难以分析

Method: 应用主题模型和传统降维方法对微生物群落数据分析

Result: 主题模型性能与传统方法相似，甚至优于某些方面

Conclusion: 主题模型有望在环境监测中发挥作用，提供生态系统新视角
