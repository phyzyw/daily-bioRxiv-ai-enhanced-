...
Conclusion: AIDO.Builder展示了AI如何加速生物医学研究中的AI发展
...
### [2] [Microbial communities in Phragmites australis biofilms from Masurian lakes (Poland) with varying trophic states](https://www.biorxiv.org/content/10.1101/2025.11.26.690845)
...
Conclusion:  freshwater biofilm 和 planktonic 社区有所不同，需要同时研究这两个方面。
...
### [3] [Impact of aging on the GABAB receptor-mediated connectome](https://www.biorxiv.org/content/10.1101/2024.07.31.606013)
*Vasquez, E., Lopez, A. L., Oresti, G. M., Paez, M. D., Callegari, E. A., Masone, D., Munoz, E. M.*

Main category: molecular dynamics

TL;DR: GABABR和KCC2在老年大鼠脑中表达和交互减少， cholesterol水平增加影响protein-protein交互.


<details>
  <summary>Details</summary>
Motivation: 研究老年大鼠脑中GABABR和KCC2的表达和交互.

Method: 蛋白表达和分布分析、共免疫沉淀分析、lipid分析和分子动力学模拟.

Result: GABABR和KCC2在老年大鼠脑中表达和交互减少， cholesterol水平增加.

Conclusion: 老年大鼠脑中GABABR的interactome信号传导受到membrane cholesterol水平的影响
