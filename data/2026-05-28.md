...
### [8] [De novo design of binder proteins targeting Helicobacter pylori adhesin BabA](https://www.biorxiv.org/content/10.64898/2026.05.24.727452)
*Zhu, Y., isah, M. b., Zhang, X.*

Main category: molecular dynamics

TL;DR: 设计了对Helicobacter pylori adhesin BabA的紧凑蛋白结合体
...
Result: 提取结构接触残基、候选功能 epitope 和候选结合体

Conclusion: 提供了一种计算框架设计紧凑蛋白结合体
...
### [9] [Design of a Multi-epitope Vaccine Against Human Glanders Targeting Outer Membrane β-barrel Proteins of Burkholderia mallei](https://www.biorxiv.org/content/10.64898/2026.05.25.727591)
*Kapoor, J., Panda, A., Kumar, S., Bandyopadhyay, A.*

Main category: molecular dynamics

TL;DR: 设计了一种多抗原疫苗对抗Burkholderia mallei感染


<details>
  <summary>Details</summary>
Motivation: 抗生素耐药性和无疫苗加剧疾病管理困难

Method: 基于计算框架、蛋白质预测和结构模拟

Result: 设计了一种780aa多抗原疫苗构建

Conclusion: 该疫苗可有效诱导免疫反应
