...
### [1] [Chemical Descriptors and Deep Learning Embeddings for Scoring de novo Peptide Designs](https://www.biorxiv.org/content/10.64898/2026.09.10.750670)
*Trolliet, Q., Abrudan, A., Bhasin, A., Fu, Y., Euko, J. P., Zhang, C., Saccon, F.*

Main category: machine learning

TL;DR: Peptides occupy a valuable niche between small molecules and biologics, but the clinical translation of de novo peptide designs requires rigorous scoring to simultaneously optimise target binding affinity alongside multiple developability traits, including stability, membrane permeability, aggregation propensity, and non-fouling behaviour. Here, we evaluate two distinct approaches for scoring these...
...
### [2] [RAxML-NG 2: Automatic model selection, novel tree search heuristics, and fast branch support metrics](https://www.biorxiv.org/content/10.64898/2026.09.09.750097)
*Kozlov, O. M., Togkousidis, A., Stelz, C., Hoehler, D., Wiegert, J., Stamatakis, A.*

Main category: machine learning

TL;DR: RAxML-NG is a widely used tool for maximum likelihood based phylogenetic inference. In the seven years since the last RAxML-NG publication, we have continuously improved and extended the code. Here, we describe the next major release, RAxML-NG 2.0. It introduces a plethora of new features: integrated model testing, multiple fast...
...
### [3] [Predicting Capsid Protein Binding Sites in Single-Stranded RNA Viruses Using Machine Learning from Local Geometric Features](https://www.biorxiv.org/content/10.64898/2026.09.10.750674)
*Wu, Y. M., Zhang, J.*

Main category: machine learning

TL;DR: Selective recognition of viral RNA by capsid proteins is essential for genome packaging during the assembly of single-stranded RNA (ssRNA) viruses. However, identification of capsid protein binding sites in the RNA genome remains challenging because current experimental techniques are labor-intensive and low-throughput, motivating the development of computational approaches. Here, we...
...
### [6] [Cyanophage CP12 Rewires Host Carbon Regulation through Interface Remodeling and Redox Buffering](https://www.biorxiv.org/content/10.64898/2026.09.10.750766)
*Widmann, S., Wu, R., Nelson, M., Mejia-Rodriguez, D., samantray, s., Neff, R., Feng, S., Li, X., Rozum, J., George, A., Rigor, P., Bohutskyi, P., Boise, N., Kim, H., Anderson, L. N., QIAN, W.-J., Olaleye, E., Idowu, K., Andersen, A., Cheung, M. S.*

Main category: molecular dynamics

TL;DR: Picocyanobacteria drive ocean carbon fixation, and cyanophages reshape host metabolism during infection. In cyanobacteria, the intrinsically disorder Calvin cycle protein 12 (CP12) assembles glyceraldehyde-3-phosphate dehydrogenase (GAP2) and phosphoribulokinase (PRK) into the inhibitory dark complex, yet how phage CP12 homologs modulate redox-sensitive partners remains unclear. Here, we examined viral CP12 across...
