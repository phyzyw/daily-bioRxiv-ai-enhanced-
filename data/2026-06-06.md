...
### [1] [Scaling SMILES-Based Chemical Language Models for Therapeutic Peptide Engineering](https://www.biorxiv.org/content/10.64898/2026.01.06.697994)
...
### [2] [MarkerScout: A Disease-Agnostic Machine Learning Framework for Biomarker Prediction from Multi-Scale Mechanistic Models](https://www.biorxiv.org/content/10.64898/2026.05.30.727266)
*Moore, R. B., Agayie-Ntim, F., Crawford, L. B., Packrisamy, P., Hamed, A. A., Helikar, T.*

Main category: machine learning

TL;DR: Identifying robust biomarkers from high-dimensional biomedical data is a central challenge in translational research, but candidate rankings produced by any single feature-selection or classification method depend on algorithmic choices and rarely reproduce across pipelines. We present a disease-agnostic machine-learning framework that addresses this dependence by systematically benchmarking 25 (feature-selection x...
...
### [5] [Quantifying the contribution of DNA conformational flexibility to transcription factor binding on nucleosomal DNA uncovers indirect readout across diverse TF families](https://www.biorxiv.org/content/10.1101/2025.05.21.655105)
*Dey, U., Martinez, G. S., Kumar, R., Yella, V. R., Kumar, A.*

Main category: molecular dynamics

TL;DR: Background: Eukaryotic gene regulation depends on transcription factors (TFs) recognizing short DNA motifs within chromatin. Many of these motifs lie within nucleosomes, where DNA is sharply bent, rotationally phased, and constrained by histone-DNA contacts. Yet only a subset is occupied in any cellular context. Motif identity alone, therefore, cannot fully...
