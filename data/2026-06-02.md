...
### [1] [Exploring diverse routes to high-affinity-antibody variable domains through deep-sequencing-informed machine learning](https://www.biorxiv.org/content/10.64898/2026.05.28.728451)
*Kawada, S., Ito, T., Nakazawa, H., Kurumida, Y., Saito, Y., Umetsu, M.*

Main category: machine learning

TL;DR: The integration of in vitro selection, deep sequencing, and machine learning (ML) has recently been developed as a powerful strategy for discovering functional antibodies. However, how training data composition and ML search space design influence the identification of high-affinity variants remains unclear. Here, we aimed to optimize ML-integrated directed evolution...
...
### [3] [Multiplex Proteomics of Lewy Body Dementia Reveals Cerebrospinal Fluid Biomarkers of Clinical and Neuropathological Heterogeneity](https://www.biorxiv.org/content/10.1101/2025.06.10.658994)
*Higginbotham, L., Rathore, S., Shantaraman, A., Guo, Q., Fox, E. J., Bagchi, P., Wu, F., Denkinger, M. N., Hanley, D., Ashton, N. J., Alzheimer's Disease Neuroimaging Initiative,, Johnson, E. C., Lah, J. J., Levey, A. I., Seyfried, N. T.*

Main category: machine learning

TL;DR: Lewy body dementia (LBD), which encompasses Parkinson's disease dementia (PDD) and Dementia with Lewy bodies (DLB), lacks established biofluid markers of its complex clinical and neuropathological heterogeneity. Multiplex proteomic tools, such as the recently developed NUcleic acid Linked ImmunoSandwich Assay (NULISA), can assess a diverse array of neurodegenerative targets and...
...
### [5] [Quantifying and Predicting the Difficulty of Multiple Sequence Alignment with AlDiScore](https://www.biorxiv.org/content/10.64898/2026.05.29.727837)
*Bodynek, M., Martin-Fernandez, L., Bettisworth, B., Haag, J., Stamatakis, A.*

Main category: machine learning

TL;DR: Multiple Sequence Alignment (MSA) constitutes an important and frequent operation in molecular sequence data analysis. There exist numerous tools, algorithms, and criteria to infer an MSA. This plethora of available approaches to MSA may induced an ensemble of divergent MSAs for the same underlying unaligned sequence set. Even a single...
...
### [9] [A Pan-Cancer Multi-Omic SuperLearner for Regulated Cell Death Survival Topologies](https://www.biorxiv.org/content/10.64898/2026.05.29.728842)
*Rodrigues de Souza, E., Almeida Cordeiro Nogueira, H., dos Santos Lopes, V., Medina-Acosta, E.*

Main category: machine learning

TL;DR: Introduction: Regulated cell death (RCD) pathways profoundly influence tumor progression and immune modulation. In prior work, we constructed a comprehensive database mapping 25 forms of RCD across seven multi-omic layers encompassing 33 tumor types (CancerRCDShiny). Despite their robust ability to identify risk populations, translating these prognostic signatures into personalized clinical...
...
### [10] [Pressure-cooling remodeling of TMV coat protein reveals mechanically partitioned capsid dynamics and selective epitope masking](https://www.biorxiv.org/content/10.64898/2026.05.31.729108)
*Bonafe, C. F. S., Teixeira, J. P., Freire, C. C. d. M., Bajay, M. M., de Lima Neto, D. F.*

Main category: molecular dynamics

TL;DR: High hydrostatic pressure (HHP) perturbs protein assemblies by shifting conformational equilibria toward lower-volume states and by reorganizing hydration at cavities, interfaces, and solvent-exposed surfaces [@Heremans1982; @Akasaka2006; @Roche2012; @Hata2020]. Here, we integrate pressure-dependent molecular dynamics descriptors, pressure--temperature interpretation, structure-based epitope prediction, and face-resolved intersubunit metrics to examine how pressure and pressure-cooling...
