...
### [1] [CharacTERT: A machine learning tool for classifying hTERT missense variants](https://www.biorxiv.org/content/10.64898/2026.05.18.725793)
...
TL;DR: TERT missense mutations linked to Telomere Biology Disorders, machine learning models predict pathogenicity with high accuracy.


<details>
  <summary>Details</summary>
Motivation: Current predictors rely on sequence information, neglecting biological and structural context.

Method: Developed machine learning models integrating sequence- and structure-based features.

Result: Achieved high Matthews Correlation Coefficient (0.88) and robust sensitivity (0.75) on curated datasets.

Conclusion: CharacTERT web server provides insights into molecular mechanisms, aiding diagnosis and personalized treatment strategies.
...
### [2] [Accurate protein stability prediction for small domains using mega-scale experiments](https://www.biorxiv.org/content/10.64898/2026.05.19.726285)
*Cho, Y., Tsuboyama, K., Litberg, T. J., Jung, M. D., Obisesan, A., Wang, Q., Phoumyvong, C. M., Thibeault, J., Ovchinnikov, S., Rocklin, G. J.*

Main category: machine learning

TL;DR: 预测蛋白质折叠稳定性，使用大规模生物物理测量数据和机器学习方法，提高预测准确性。


<details>
  <summary>Details</summary>
Motivation: 蛋白质设计和遗传变异演化中需要预测蛋白质折叠稳定性

Method: 使用cDNA显示蛋白酶解法测量蛋白质折叠稳定性

Result: 开发了SaProtΔG和ESM3ΔG预测模型，准确预测小域蛋白质折叠稳定性

Conclusion: 大规模生物物理测量数据可以与进化和结构数据结合，提高小域蛋白质折叠稳定性预测准确性
...
### [6] [Mechanochemical Decoupling of ATP Hydrolysis and RNA Translocation in SARS-CoV-2 nsp13 by the L405D Mutation](https://www.biorxiv.org/content/10.64898/2026.05.18.726016)
*Fazelpour, E., Roy, P., Frederick, K., McCullagh, M.*

Main category: molecular dynamics

TL;DR: SARS-CoV-2 nsp13 helicase activity disrupted by L405D mutation through conformational ensemble reshaping.


<details>
  <summary>Details</summary>
Motivation: Understanding how targeted mutations affect catalytic function in motor proteins.

Method: GaMD simulations, Shape-GMM clustering, and linear discriminant analysis.

Result: L405D collapses conformational landscape, impairing product release and ATP turnover.

Conclusion: Mutation-induced reshaping of conformational ensembles modulates access to reaction-competent states.
