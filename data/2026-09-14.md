...
### [1] [Threat imminence and estimates of agency dictate proactive and reactive defensive behaviors in active place avoidance](https://www.biorxiv.org/content/10.64898/2026.09.11.750960)
*Chambard, A., Quittet, C., Boyer, S., Vilalta, T., Naude, J., Valjent, E., Bertaso, F., Besnard, A.*

Main category: machine learning

TL;DR: Defensive survival behaviors are shaped by both danger attributes and internal physiological states. Well-characterized defensive responses depend not only on whether danger is potential or perceived, but also on its spatial and or temporal proximity. The relationship between danger imminence and defensive behaviors is referred to as the threat imminence...
...
### [3] [Multi-Methodological Characterization of Sleep Deprivation: From Standard EEG Power Spectra to Aperiodic Dynamics in Humans and Mice.](https://www.biorxiv.org/content/10.64898/2026.09.08.750125)
*Kroker, T., Puder, L., Abbasi, O., Ghiasi, S., Krug, C., Wessing, I., Salehinejad, M. A., Ruland, T., Alferink, J., Dannlowski, U., Ritter, P., Gross, J.*

Main category: machine learning

TL;DR: Sleep deprivation is a potent, rapid-acting therapeutic intervention for major depressive disorder, yet its underlying neural mechanisms remain poorly understood, hindering the development of predictive biomarkers. Here, we systematically characterize the electro-physiological signatures of prolonged wakefulness using a multi-methodological approach across three independent datasets in humans and mice. By integrating...
...
### [5] [Adenosine impairs T cell function via activation of purine salvage pathway and AMP-induced inhibition of pyrimidine nucleotide biosynthesis](https://www.biorxiv.org/content/10.64898/2026.09.07.749884)
*Losenkova, K., Von Danwitz, U. J., Kreisig, N., Svard, S., Baier, J. S., Weiler, C., Zavialov, A., Thomson, N. J., Muller, C. E., Gani, O., Jalkanen, S., Takeda, A., Yegutkin, G. G.*

Main category: molecular dynamics

TL;DR: Extracellular adenosine (ADO) is a well-established immune checkpoint mediator suppressing T cells via activation of A2A receptors, yet intracellular mechanisms of ADO action remain less understood. Here, we show that activated human T cells transport extracellular ADO through equilibrative nucleoside transporter 1 (ENT1) and metabolize it through ATP salvage pathway....
...
### [7] [Curcumin - Gold Nanocomposites for Enhanced Cationic Anticancer Drug Delivery: Molecular Mechanisms of Loading and Membrane Interactions](https://www.biorxiv.org/content/10.64898/2026.05.18.725887)
*Garg, A., Barik, S., Nair, H., Nair, S. G., Kiran Kumar, J. K., Kanchi, S.*

Main category: molecular dynamics

TL;DR: Curcumin-functionalized gold nanoclusters are promising platforms for catalysis and drug delivery, however, the molecular determinants governing their stability, morphology, and solvent response remain poorly understood. Here, microsecond all-atom molecular dynamics simulations were employed to investigate a 2 nm gold nanoparticle noncovalently coated with different curcumin forms, including the neutral enol...
...
### [8] [SARS-CoV-2 Main Protease Inhibition Through Dimerization Promotion by Peptidomimetic Inhibitors and Disruption by Ebselen](https://www.biorxiv.org/content/10.1101/2025.11.16.688752)
*Liu, C., Jia, Q., Zhao, C., Zhongping, Y.*

Main category: molecular dynamics

TL;DR: The SARS-CoV-2 main protease (Mpro) is a key antiviral target that equilibrates between an active dimer and inactive monomer, making the dimerization interface a promising therapeutic vulnerability. This study investigates Mpro monomer-dimer equilibrium and conformational changes induced by inhibitor binding using 13C labeling with native mass spectrometry and hydrogen/deuterium exchange...
