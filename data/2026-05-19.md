...
### [1] [Multivariate Bayesian Inversion for Classification and Regression](https://www.biorxiv.org/content/10.1101/2025.05.09.653015)
*Soch, J., Allefeld, C.*
...
### [6] [Excitatory Dysfunction and Phenotypic Rescue in a Human Neuronal Model of SCN2A-Related Disorders](https://www.biorxiv.org/content/10.64898/2026.05.18.725745)
...
### [9] [Learning the Language of the Microbiome with Transformers](https://www.biorxiv.org/content/10.64898/2026.05.02.722381)
*Treloar, N. J., Ur-Rehman, S., Yang, J.*

Main category: machine learning

TL;DR: 微生物学领域的自监督预训练模型Waypoint，基于大规模数据集Atlas和评估框架Compass，取得了优异的下游任务性能。


<details>
  <summary>Details</summary>
Motivation: 微生物学数据仍然较少被用于模型和评估框架中

Method: 使用Atlas数据集训练Waypoint系列模型，评估Compass评估框架

Result: 预训练模型在下游任务中取得了明显改进，数据集规模和tokenization策略对模型质量的影响

Conclusion: 自监督预训练在微生物学领域非常重要，Waypoint模型和Atlas、Compass资源为研究社区提供了有价值的资源
