...
### [3] [Interpreting the WaveSeekerNet model to reveal the evolution and biology of influenza A virus](https://www.biorxiv.org/content/10.64898/2026.05.23.726879)
*Nguyen, H.-H., Rudar, J., Mubareka, S., Lapen, D., Berhane, Y., Leung, C. K., Lung, O.*

Main category: machine learning

TL;DR: IAV host-adaptation机制模拟


<details>
  <summary>Details</summary>
Motivation: 预防流行病，了解IAV基因组适应性

Method: WaveSeekerNet模型

Result: 准确预测宿主来源、host-adaptive distance

Conclusion: IAV宿主适应机制模拟，提高监测和干预策略
...
TL;DR: Bromo：一个 transformer-based深度学习模型，选择目标肽段考虑电荷状态


<details>
  <summary>Details</summary>
Motivation: 当前机器学习工具有多种限制，无法选择合适的肽段

Method: 使用 transformer-based深度学习模型，训练于大规模数据独立获取质谱数据

Result: Bromo在多个独立数据集上超越现有序列基于方法

Conclusion: Bromo适用于选择目标肽段，适应不同实验条件
