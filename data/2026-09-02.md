...
### [1] [Intelligent differential ion mobility spectrometry (iDMS): A deep neural network that predicts optimal space-resolved ion mobility parameters for isomeric monoglycosphingolipids](https://www.biorxiv.org/content/10.64898/2026.08.26.747394)
*Nguyen-Tran, T., Shi, X. X., Hashimoto-Roth, E., Organ, M. G., Lavallee-Adam, M., Perkins, T. J., Bennett, S. A. L.*

Main category: machine learning

TL;DR: Simultaneous quantification of monoglycosphingolipid stereoisomers is required to monitor changes in defective enzymatic pathways linked to diseases such as Gaucher Disease, Parkinson's Disease, and Krabbe Disease. Resolution of beta-glucosyl and beta-galactosyl epimers cannot be achieved by standard liquid chromatography, electrospray ionization, tandem mass spectrometry (LC-ESI-MS/MS). Separation becomes possible when field...
...
### [2] [Function-driven geometry directs human pilosebaceous unit development](https://www.biorxiv.org/content/10.64898/2026.08.31.745265)
...
TL;DR: Single-cell technologies have generated cell censuses of tissues, however, how tissue geometry reflects functional needs remains poorly characterized. The human pilosebaceous unit offers a tractable model, a prenatally-formed complex mini-organ combining hair and sebum production with a stem cell reservoir. Using histomorphology, spatial transcriptomics, and single-cell multiomics on the same...
...
### [3] [Abundant Glomerular Neutrophil Extracellular Traps in C3 Glomerulopathy](https://www.biorxiv.org/content/10.64898/2026.08.27.747386)
*O'Sullivan, K., khandelwal, p., Walker, P. D., hickey, m., Licht, C.*

Main category: machine learning

TL;DR: Introduction: C3 glomerulopathy (C3G) is driven by fluid-phase alternative complement pathway dysregulation, with emerging evidence linking glomerular neutrophil infiltration to disease severity. Neutrophil extracellular traps (NETs) are implicated in other forms of glomerulonephritis. However, their participation in the pathogenesis of C3G remains undefined. Methods: Kidney biopsies from 33 patients with...
...
### [5] [High-Resolution Subtyping of Pediatric Low-Grade Glioma Using an Integrated Meta-Clustering Framework](https://www.biorxiv.org/content/10.64898/2026.08.27.747680)
*Tuerhanbayi, B., Wang, J., Wan, S.*

Main category: machine learning

TL;DR: Pediatric low-grade glioma (pLGG) is the most common type of brain tumor in children, accounting for approximately 30% of all central nervous system tumors in children. pLGG has multiple molecular subtypes that differ in disease progression, recurrence patterns, and treatment responses. Conventional wet lab approaches including molecular profiling and histopathological...
...
### [6] [Cryo-EM Structure of a Triazole alpha-Conotoxin GI Mimetic Bound to the Muscle-Type Nicotinic Acetylcholine Receptor](https://www.biorxiv.org/content/10.64898/2026.08.31.748223)
...
### [7] [A transition state-like acylenzyme conformation distinguishes carbapenemase activity in class A β-lactamases](https://www.biorxiv.org/content/10.64898/2026.08.31.748333)
*Beer, M., Spencer, J., Mulholland, A. J.*

Main category: molecular dynamics

TL;DR: Carbapenems are the most potent {beta}-lactams, key antibiotics for healthcare-associated infections by Gram-negative bacteria and evade hydrolysis by most {beta}-lactamases, but are increasingly threatened by emergence of enzymes exhibiting hydrolytic activity towards them. Of the four recognised {beta}-lactamase subclasses, class A (active-site serine enzymes that hydrolyse {beta}-lactams via a covalent...
