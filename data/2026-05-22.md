...
### [1] [Antimicrobial peptide databases and prediction tools: Toward a standard evaluation framework](https://www.biorxiv.org/content/10.64898/2026.05.19.726290)
...
TL;DR: AMR crisis calls for novel antibiotics; antimicrobial peptides (AMPs) may offer a solution; evaluation criteria and benchmark resources are needed for fair assessment of AMP prediction tools.


<details>
  <summary>Details</summary>
Motivation: AMR has a profound impact on animal and human health; novel antibiotic agents are needed; AMPs have attracted attention for their potential to combat AMR.

Method: Comparing AMP databases, assessing existing computational tools, proposing a reference evaluation framework, and providing recommendations for future tool development.

Result: Proposed evaluation framework aims to improve comparability, reproducibility, and practical utility in ABP prediction.

Conclusion: Robust progress in computational discovery of ABPs requires standardized evaluation criteria and benchmark resources.
...
### [2] [Equilibrium Propagation with Predictive Learning in Leaky Integrate-and-Fire Spiking Neural Networks](https://www.biorxiv.org/content/10.64898/2026.05.19.726261)
*Kubo, Y.*

Main category: machine learning

TL;DR: EP-based SNN framework combines LIF neural dynamics with predictive learning rule, achieving competitive accuracy on image classification benchmarks.


<details>
  <summary>Details</summary>
Motivation: Biologically plausible alternative to backpropagation, leveraging leaky integrate-and-fire neurons and spike-based plasticity rules.

Method: Propose EP-based SNN framework, replacing STDP with predictive learning rule, and evaluate on multiple image classification benchmarks.

Result: EP-based LIF model achieves competitive accuracy, with performance approaching BP-trained counterpart, while relying on biologically motivated local learning rule.

Conclusion: Predictive learning supports effective EP-based training in LIF spiking networks, with differences in activity patterns motivating future work.
...
### [3] [Overcoming systematic data biases enables accurate prediction of enzyme kcat fold-changes for computational protein design](https://www.biorxiv.org/content/10.64898/2026.01.23.701068)
*Rousset, Y., Kroll, A., Lercher, M.*

Main category: machine learning

TL;DR: 机器学习用于蛋白质工程预测突变对酶活性的影响，但存在偏见问题


<details>
  <summary>Details</summary>
Motivation: 评估模型性能的挑战在于确定是否捕捉到突变特异性效应

Method: 提出了一种偏见-aware框架，使用pairwise fold-change任务评估性能

Result: 在控制leakage的benchmark上超越了现有模型

Conclusion: 为蛋白质工程和相关领域提供了一种评估和建模突变效应的通用策略
...
### [4] [A single-nucleotide change in the Kozak sequence enhances protein expression](https://www.biorxiv.org/content/10.64898/2026.05.20.726450)
*Knol, R., Fariaby, T., de Vlieger, E. A., Kros, A., Sluetter, B.*

Main category: machine learning

TL;DR: IVT mRNA表达平台优化，Kozak序列优化提高翻译效率


<details>
  <summary>Details</summary>
Motivation: 当前IVT mRNA优化策略忽视Kozak序列

Method: 系统变异Kozak序列，UTR上下文中组合优化

Result: 单核苷酸Kozak序列优化提高蛋白表达

Conclusion: Kozak序列优化对翻译效率的重要性
...
### [8] [Spatiotemporal graph neural networks reveal conformational binding signature in protein dynamics](https://www.biorxiv.org/content/10.64898/2026.05.19.726195)
*Motta, S., Santini, G., Mansoor, S., Nezhad, F. H., Meli, M., Pandini, A.*

Main category: molecular dynamics

TL;DR: MD simulation noise filtering via deep learning for biomolecular function analysis


<details>
  <summary>Details</summary>
Motivation: Separate functional signatures from stochastic noise in MD simulations

Method: Dynamic protein graph representation + group-aware contrastive learning + explainable AI framework

Result: Identify binding-ready conformations, allosteric determinants, and ligand-independent activation signatures

Conclusion: GISTnet-MD generalizes across unseen data for comparative MD analysis
