...
### [1] [On the robustness of scRNA-seq foundation models for plant perturbation response prediction under cross-experiment shift](https://www.biorxiv.org/content/10.64898/2026.08.21.746324)
*Fernandez Burda, M., Bonazzola, R., Valli, A. A., Castrillo, G., Stegmayer, G., Ferrante, E., Milone, D. H.*

Main category: machine learning

TL;DR: Foundation models for single-cell transcriptomics promise to learn generalizable representations of cellular states. However, recent evidence suggests they often fail to outperform simple machine learning baselines. Furthermore, their ability to generalize across unseen experimental conditions remains poorly understood, particularly in plants, where rigorous evaluation beyond cell type annotation and batch...
...
### [3] [InterPET: A Curated Benchmark of Sequence Embeddings and Graph Architectures with Interpretability and Biological Validation for PETase Activity Prediction](https://www.biorxiv.org/content/10.64898/2026.08.18.745360)
...
### [4] [Classifying CRISPR-Cas9 Off-Target Cleavage Sites from GUIDE-seq Data: A Class-Imbalanced Machine Learning Benchmark](https://www.biorxiv.org/content/10.64898/2026.08.19.745843)
*Sarvi, D., Alasyam, J.*
...
### [5] [Transferable Collective Variable to accelerate Protein-Ligand (Un)Binding Transitions via Explainable Machine Learning and Intriguing Role of Ligand Solvation](https://www.biorxiv.org/content/10.64898/2026.08.21.746233)
*Dhibar, S., Jana, B.*

Main category: machine learning + molecular dynamics

TL;DR: The process of drug unbinding is of immense importance in the field of biophysics and therapeutics. The behavior of these systems is greatly influenced by their thermodynamic and kinetic properties. Therefore, it is crucial to accurately estimate the ligand binding free energies and rate of ligand dissociation, yet these processes...
...
### [6] [Autotransporter folding avoids a kinetic trap during vectorial translocation across the bacterial outer membrane](https://www.biorxiv.org/content/10.64898/2026.08.22.746429)
*Yang, L., Luan, Q., Baxa, M., Clark, P. L., Gumbart, J.*

Main category: molecular dynamics

TL;DR: Autotransporter proteins are major virulence factors in Gram-negative pathogens, yet how they fold during secretion remains incompletely understood. A longstanding puzzle is why pertactin folds and is secreted in vivo within minutes but refolds in vitro over hours to days. We introduce BEAM, a multiscale framework that learns slow collective...
...
### [8] [Inferring protein ensembles directly from NOESY spectra](https://www.biorxiv.org/content/10.64898/2026.08.20.745893)
*Coles, M.*
...
### [9] [Beyond Co-Existence: Early α-Synuclein-Amyloid-β42 Association from Molecular Dynamics Simulations](https://www.biorxiv.org/content/10.64898/2026.01.29.702600)
